...
const loginUser = async (email, password) => {
  try {
    ...
    const response = await fetch(
      "https://softjovial-org-backend-production.up.railway.app/api/user/login",
...
const complete_registration = async (userInfo) => {
  try {
    ...
    const response = await fetch(
      "https://softjovial-org-backend-production.up.railway.app/api/new_user/complete_registration",
